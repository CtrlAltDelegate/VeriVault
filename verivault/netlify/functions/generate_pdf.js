    ...
    `).join('') : ''}
        ...
        <div class="digital-signature">
            ...
            <div class="signature-line">
                ...
                <span>VeriVault AI Intelligence System</span>
            </div>
            <div class="signature-line">
                <span>Report ID:</span>
            ...
            <div class="signature-line">
                ...
                <span style="color: #22c55e; font-weight: 700;">[AI-VERIFIED ✓]</span>
            </div>
            <div class="signature-line">
                <span>Security Clearance:</span>
                <span style="color: #F59E0B; font-weight: 700;">AUTHORIZED PERSONNEL ONLY</span>
            </div>
            <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #00CFFF; font-size: 7px; color: #F3F4F6;">
                This document contains classified operational intelligence. Distribution restricted per security protocols. Unauthorized disclosure prohibited under applicable security regulations.
            </div>
        </div>
    </div>
